...
class TestDisableDeleteGroup(SavepointCase):
    @patch('odoo.addons.n_user_access_delete.models.ir_http.request')
    ...
    def test_session_info(self, request, request1, request2):
        ...
        self.assertTrue(session_info['group_delete_data'])
    ...
    def test_session_info_not_allowed(self, request, request1, request2):
        ...
        self.assertFalse(session_info['group_delete_data'])
