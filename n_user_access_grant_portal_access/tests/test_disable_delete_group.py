...
class TestDisableGrant_portal_accessGroup(SavepointCase):
    @patch('odoo.addons.n_user_access_grant_portal_access.models.ir_http.request')
    ...
    def test_session_info(self, request, request1, request2):
        ...
        self.assertTrue(session_info['group_grant_portal_access_data'])
    ...
    def test_session_info_not_allowed(self, request, request1, request2):
        ...
        self.assertFalse(session_info['group_grant_portal_access_data'])
